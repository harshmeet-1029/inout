  ...
  <div class="wrapper">          
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="assets/img/sidebar.jpg">
      ...
      <div class="sidebar-wrapper"> 
        <div class="user">
          <div class="photo">
              <img src="assets/img/faces/logo.jpg">
          </div>
          <div class="user-info">
        ...
        <ul class="nav">
          ...
          <?php
            ...
            ?>
             <?php
            if(in_array('UP', $user_access)){
              

          ?>
            <li class="nav-item <?php if($title == 'Upload') echo 'active'; ?>">
              <a class="nav-link" href="supload.php"><i class="material-icons">speaker_notes</i><p>Student Upload</p></a>
            </li>
          <?php
            }
            ?>
